...
import com.xu.myandroidtest.bean.JsonBean;
import com.xu.myandroidtest.utils.*;
...
public class CreateAddressActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_LOAD_FAILED:
                    Toast.makeText(CreateAddressActivity.this,"Parse Failed", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    private void ShowPickerView() {// 弹出选择器
        ...
        OptionsPickerView pvOptions = new OptionsPickerView.Builder(this, new OptionsPickerView.OnOptionsSelectListener() {
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                areaTV.setText(tx);
               // Toast.makeText(CreateAddressActivity.this,tx,Toast.LENGTH_SHORT).show();
            }
        })
    ...
    private void initJsonData() {//解析省市区数据
